                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                <form>
                                    <div class="mb-4">
                                        <label for="addgroupname-input" class="form-label">Number Search</label>
                                        <input type="text" class="form-control" id="addgroupname-input" placeholder="Enter number..">
                                    </div>
                                    <div class="mb-4">
                        ...
                        <a href="#">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    <h5 class="text-truncate font-size-14 mb-0"># 01837664478</h5>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    <h5 class="text-truncate font-size-14 mb-0"># 01403251501<span class="badge badge-soft-danger rounded-pill float-end">+23</span></h5>
                                </div>
                            </div>
                        </a>
                    </li>
